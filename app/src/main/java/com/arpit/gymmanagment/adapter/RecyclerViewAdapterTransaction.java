...
import com.arpit.gymmanagment.Transactions;
...
public class RecyclerViewAdapterTransaction extends RecyclerView.Adapter<RecyclerViewAdapterTransaction.ViewHolder> {
    ...
    public RecyclerViewAdapterTransaction(Context context, List<Members> memberList) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterTransaction.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterTransaction.ViewHolder holder, int position) {
