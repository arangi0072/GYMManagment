...
import com.arpit.gymmanagment.MemberDetails;
...
public class RecyclerViewAdapterMember extends RecyclerView.Adapter<RecyclerViewAdapterMember.ViewHolder> {
    private Context context;
    private List<Members> memberList;

    public RecyclerViewAdapterMember(Context context, List<Members> memberList) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterMember.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterMember.ViewHolder holder, int position) {
